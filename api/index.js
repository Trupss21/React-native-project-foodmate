...
mongoose
  .connect("mongodb+srv://truptigavit:FoodMate@cluster0.atborxx.mongodb.net/")
  .then(() => {
...
const sendVerificationEmail = async (email, verificationToken) => {
  const transporter = nodemailer.createTransport({
    service: "gmail",
    auth: {
      user: "wearecreators24@gmail.com",
      pass: "iekc dsty mbqv gpbi",
    },
  });

  const mailOptions = {
    from: "foodmatezyra.com",
    to: email,
